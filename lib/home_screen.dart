...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Future<void> _sendSOS() async {
    ...
    try {
      ...
      if (!serviceEnabled) {
        setState(() => status = "❌ Location is turned OFF on this device. Enable it in system settings.");
        return;
      }
      ...
      if (permission == LocationPermission.deniedForever) {
        setState(() => status = "❌ Location permission denied. Enable it in Settings.");
        return;
      }
            ...
            children: [
              ...
              TextButton(
                onPressed: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (_) => const AppHomeListenerScreen()),
                  );
                },
