...
class _AppHomeListenerScreenState extends State<AppHomeListenerScreen> {
  ...
  void _handleSosTriggered(String detectedPhrase, bool viaWakeName) {
    _navigateToCountdown(detectedPhrase: detectedPhrase, triggerSource: 'voice');
  }

  void _handleManualTrigger() {
    _navigateToCountdown(detectedPhrase: 'manual button press', triggerSource: 'manual_button');
  }

  void _navigateToCountdown({required String detectedPhrase, required String triggerSource}) {
