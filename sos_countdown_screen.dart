  ...
  Future<void> _escalate() async {
    ...
    try {
      ...
      try {
        ...
        debugPrint('Could not get current position, falling back to last known: $e');
  ...
  Widget build(BuildContext context) {
    ...
    if (_outcome == 'escalated') {
      return _buildOutcomeScreen(
        ...
        title: 'Alert Sent',
        message:
            'Your emergency contacts have been notified via WhatsApp and phone call.',
      );
    }
    ...
    if (_outcome == 'escalation_failed') {
      return _buildOutcomeScreen(
        ...
        message:
            'Please call your emergency contacts directly, or check your internet connection.',
      );
    }
